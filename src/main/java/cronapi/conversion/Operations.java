...
public class Operations {
	...
	@CronapiMetaData(type = "function", name = "{{toLogic}}", nameSynonymous = {
			"toBoolean" }, description = "{{functionConvertToLogic}}", params = { "{{content}}" })
	protected final Var toBoolean(Var var) throws Exception {
		return new Var(Functions.stringToBoolean(var.getObjectAsString()));
	}

	@CronapiMetaData(type = "function", name = "{{base64ToText}}", nameSynonymous = {
			"base64ToString" }, description = "{{functionConvertBase64ToText}}", params = { "{{contentInBase64}}" })
	...
	@CronapiMetaData(type = "function", name = "{{textToTextBinary}}", nameSynonymous = {
			"asciiToBinary" }, description = "{{functionToConvertTextInTextBinary}}", params = { "{{contentInAscii}}" })
	...
	@CronapiMetaData(type = "function", name = "{{textBinaryToText}}", nameSynonymous = {
