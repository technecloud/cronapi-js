...
public @interface CronapiMetaData {
  ...
  public enum CategoryType {
    AUTHENTICATION, IO, DATABASE, FRONTEND, SCREEN, CONVERSION, DATETIME, XML, EMAIL, FTP, JSON, LOGIC, TEXT, LIST, MAP, COLOR, LOOP, MATH, GRID, PRINT, OTHER, OBJECT, SEMAPHORE, UTIL, JSONORMAP, TREE, CHART,SOCIAL, REGEX
  }
