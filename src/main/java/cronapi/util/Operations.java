...
public class Operations {
  ...
  public static final void callBlocklyNoReturn(@ParamMetaData(type = ObjectType.STRING, description = "{{callBlocklyNoReturnParam0}}") Var classNameWithMethod,
  ...
  public static final void callClientFunction(@ParamMetaData(type = ObjectType.STRING, description = "{{callClienteFunctionParam0}}") Var function,
  ...
  public static final Var callBlockly(Var classNameWithMethod, boolean checkSecurity, String restMethod, Var ... params)
          throws Exception {
  ...
  @CronapiMetaData(type = "function", name = "{{matchesencryptPasswordName}}", nameTags = {
      "matchesencryptPassword" }, description = "{{matchesencryptPasswordDescription}}", params = {
          "{{matchesencryptPasswordParam0}}", "{{matchesencryptPasswordParam1}}" }, paramsType = { ObjectType.STRING,
  ...
  public static final Var getHeadersFromExternalURL(@ParamMetaData(type = ObjectType.STRING, description = "{{HTTPMethod}}", blockType = "util_dropdown", keys = {
      "GET", "POST", "PUT",
      "DELETE" }, values = { "{{HTTPGet}}", "{{HTTPPost}}", "{{HTTPPut}}", "{{HTTPDelete}}" }) Var method,
                                                    ...
                                                    @ParamMetaData(type = ObjectType.STRING, description = "{{contentType}}", blockType = "util_dropdown", keys = {
                                                        ...
                                                        "application/json" }, values = { "{{x_www_form_urlencoded}}",
                                                            "{{app_json}}" }) Var contentType,
  ...
  public static final Var getURLFromOthers(@ParamMetaData(type = ObjectType.STRING, description = "{{HTTPMethod}}", blockType = "util_dropdown", keys = {
      "GET", "POST", "PUT",
      "DELETE" }, values = { "{{HTTPGet}}", "{{HTTPPost}}", "{{HTTPPut}}", "{{HTTPDelete}}" }) Var method,
                                           
                                           @ParamMetaData(type = ObjectType.STRING, description = "{{contentType}}", blockType = "util_dropdown", keys = {
                                               "application/x-www-form-urlencoded", "application/json" }, values = {
                                                   "{{x_www_form_urlencoded}}", "{{app_json}}" }) Var contentType,
  ...
  private static final Var getContentFromURL(Var method, Var contentType, Var address, Var params, Var cookieContainer,
                                             Var returnType)
          throws Exception {
    try {
      ...
      if(method.getObjectAsString().toUpperCase().equals("GET")) {
        ...
        headerObject.entrySet().stream().forEach((entry) -> {
          httpGet.addHeader(entry.getKey().getObjectAsString(), new Var(entry.getValue()).getObjectAsString());
        });
        ...
        Map<Var, Var> headerObject = (Map<Var, Var>)cookieContainer.getObjectAsMap();
        headerObject.entrySet().stream().forEach((entry) -> {
          httpPost.addHeader(entry.getKey().getObjectAsString(), new Var(entry.getValue()).getObjectAsString());
        });
        ...
        Map<Var, Var> headerObject = (Map<Var, Var>)cookieContainer.getObjectAsMap();
        headerObject.entrySet().stream().forEach((entry) -> {
          httpPut.addHeader(entry.getKey().getObjectAsString(), new Var(entry.getValue()).getObjectAsString());
        });
        ...
        Map<Var, Var> headerObject = (Map<Var, Var>)cookieContainer.getObjectAsMap();
        headerObject.entrySet().stream().forEach((entry) -> {
          httpDelete.addHeader(entry.getKey().getObjectAsString(), new Var(entry.getValue()).getObjectAsString());
        });
  ...
  public static final Var getValueFromSession(@ParamMetaData(type = ObjectType.STRING, description = "{{fieldName}}") Var fieldName)
          throws Exception {
  ...
  public static final void getValueFromSession(@ParamMetaData(type = ObjectType.STRING, description = "{{fieldName}}") Var fieldName,
